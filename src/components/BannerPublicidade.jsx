    ...
    <section className="pt-20">
      <div className="px-10 xl:flex xl:justify-center xl:gap-40 lg:place-content-center lg:grid lg:gap-0">
        ...
        <div className="lg:pb-10 ssm:pb-10">
          <h4 className="ssm:text-lg xl:text-xl text-primary" ><b>Oferta especial</b></h4>
          <h1 className="ssm:text-3xl ssm:py-1 xl:text-5xl xl:py-2">Air Jordan edição <br /> de colecionador</h1>
          <p className="ssm:text-sm ssm:py-2 xl:text-lg xl:py-3">
